...
import { submittingTx, fetchPeople, fetchTxs } from '../../data/LeadgerArea/actions';
...
const mapDispatchToProps = (dispatch: Dispatch<ActionTypes>) => {
  return {
    submittingTx: (personId: string, amount: number, description: string, date: Date) => {
...
const LedgerAreaContainer = connect(mapStateToProps, mapDispatchToProps)(LedgerArea);
